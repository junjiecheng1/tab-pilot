...
/// 获取文档信息
pub async fn get_doc_info(client: &TabClient, doc_id: &str) -> Result<Value> {
...
/// 批量获取文档信息
pub async fn batch_get_info(client: &TabClient, urls: &[String]) -> Result<Value> {
    client::doc::batch_get_doc_info(client, urls, true).await
}

/// 解析文档 URL
pub async fn parse_urls(client: &TabClient, urls: &[String]) -> Result<Value> {
...
pub async fn list_doc(client: &TabClient, doc_id: &str, page_size: i32) -> Result<Value> {
